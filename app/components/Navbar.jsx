...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`w-full fixed flex justify-between items-center px-6 py-4 z-50 transition-all duration-300 
        ${isScrolled ? "bg-white shadow-md" : "bg-transparent"}`}
      >
        {/* Logo */}
        <a href="#top" className="text-3xl font-bold">
          Laura Pro Cleaners
        </a>
        ...
        <div className="lg:flex items-center ">
          ...
          <a
            href="/signup"
            className="flex items-center  hover:text-white border
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed top-0 right-0 w-64 shadow-sm transform ${
        ...
        >
          <ul className="flex flex-col gap-6 p-12 pt-20 backdrop-blur-sm h-screen">
            <li className="hover:text-blue-500 transition">
              <a href="#top" onClick={handleToggle}>
                Home
              </a>
            </li>
            <li className="hover:text-blue-500 transition">
